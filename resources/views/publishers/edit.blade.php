    ...
    <div class="main">
        <div class="col-main">
            ...
            <div class="row">
                ...
                <form action="{{route('publishers.update',[$publishers->id])}}" method="post" >
                    {{csrf_field()}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="name" class="form-control col-md-12 col-xs-12" name="name" placeholder="Enter publishers name" required="required" type="text" value="{{old('name',$publishers->name)}}">
